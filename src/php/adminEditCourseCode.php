...
$avaiableSeats = $_POST['availableSeats'];
$day1 = $_POST['day1'];
$day2 = $_POST['day2'];
...
$days              = $day1 . "," . $day2;
$seatsDifference = $avaiableSeats - $session_available_seats;
...
$sql_update_course = "update  cr_course_enrollment a set available_seats='$avaiableSeats', class_no='$room_num', class_start_time='$startTime',remaining_seats=a.remaining_seats+'$seatsDifference',
